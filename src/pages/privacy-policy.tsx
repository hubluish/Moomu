...
export default function PrivacyPolicy() {
  ...
  const privacyContent = `
    <h2>개인정보처리방침</h2>
    <p><strong>시행일자: 2025년 7월 13일</strong></p>
    ...
    <h3>□ 처리하는 개인정보 항목</h3>
    <p>Moomu는 다음과 같은 개인정보 법적 근거로 정보주체의 개인정보를 수집 및 이용합니다.</p>
    
    <h4>정보주체의 동의를 받지 않고 처리하는 개인정보 항목</h4>
    <p>Moomu는 다음의 개인정보 항목을 정보주체의 동의 없이 처리하고 있습니다.</p>
    <ol>
      <li><strong>회원 서비스 운영</strong>
        <ul>
          <li>법적 근거 : 「개인정보 보호법」 제15조제1항제4호('계약 체결·이행')</li>
    ...
    <ol>
      <li><strong>홈페이지 회원 가입 및 관리</strong> : 회원 탈퇴 시 까지<br>
      ...
      <li><strong>재화 또는 서비스 제공</strong> : 재화·서비스 공급완료 및 요금결제·정산 완료시까지<br>
      다만, 다음의 사유에 해당하는 경우에는 해당 기간 종료 시까지
        <ul>
          <li>계약 또는 청약철회 등에 관한 기록: 5년 (「전자상거래 등에서의 소비자보호에 관한 법률 시행령」 제6조제 1항제2호)</li>
          <li>대금결제 및 재화 등의 공급에 관한 기록: 5년 (「전자상거래 등에서의 소비자보호에 관한 법률 시행령」 제6조 제1항제3호)</li>
        </ul>
      </li>
    </ol>
    ...
    <p>⑤ 다른 법령에서 그 개인정보가 수집 대상으로 명시되어 있는 경우에는 해당 개인정보의 삭제를 요구할 수 없습 니다.</p>
    ...
    <h3>□ 개인정보 처리방침의 변경</h3>
    <p>① 이 개인정보 처리방침은 2025.7.13부터 적용됩니다.</p>
  `;
      ...
      <div className={styles.titleSection}>
        <div className={styles.titleInner}>
          <div className={styles.titleRow}>
            ...
            <div className={styles.dateText}>2025.07.13</div>
          </div>
